...
router.post('/categories', multer_middleware_1.default.single('image'), categoryController.createCategory);
router.put('/categories/:id', multer_middleware_1.default.single('image'), categoryController.editCategory);
