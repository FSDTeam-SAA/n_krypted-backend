...
// Create a new deal
router.post('/deals', multer_middleware_1.default.array('images'), dealController.createDeal);
// Get all deals
router.get('/deals', dealController.getAllDeals);
// Get single deal
router.get('/deals/:id', dealController.getSingleDeal);
// Update a deal
router.put('/deals/:id', multer_middleware_1.default.array('images'), dealController.updateDeal);
// Delete a deal
