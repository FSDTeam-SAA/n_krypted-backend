...
router.post('/owner/restaurant', auth_middleware_1.default, (0, authorizeRoles_1.default)('restaurant_owner'), multer_middleware_1.default.array('images', 4), restaurantController.createOwnerRestaurant);
router.put('/owner/restaurant/:id', auth_middleware_1.default, (0, authorizeRoles_1.default)('restaurant_owner'), multer_middleware_1.default.array('images', 4), restaurantController.resubmitOwnerRestaurant);
