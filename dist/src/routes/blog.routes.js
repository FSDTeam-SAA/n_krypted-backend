...
router.post('/blog/', multer_middleware_1.default.single('image'), blogController.createBlog);
router.get('/blog', blogController.getBlogs);
router.get('/blog/:id', blogController.getBlog);
router.put('/blog/:id', multer_middleware_1.default.single('image'), blogController.updateBlog);
