...
const sendBookingConfirmationEmail = async (to, bookingDetails, dealDetails, userDetails) => {
    ...
    const formattedDate = new Date(bookingDetails.scheduleDate).toLocaleDateString("de-DE", {
        weekday: "long",
        year: "numeric",
        month: "long",
        day: "numeric",
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="booking-card">
        ...
        <div class="booking-id-badge">Buchungs-ID: #${bookingDetails.bookingId.slice(-4)}</div>
        ...
        <div class="detail-row">
          ...
          <span>${dealDetails.location.city}, ${dealDetails.location.country}</span>
        </div>
...
`;
    const mailOptions = {
        from: `"${process.env.EMAIL_FROM_NAME || "Buchungssystem"}" <${process.env.BOOKING_EMAIL_USER}>`,
        to,
